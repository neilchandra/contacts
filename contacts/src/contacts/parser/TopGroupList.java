...
public class TopGroupList implements ParseNode, Group {
	...
	/**
	 * Constructs a TopGrouplist from a groupName, a groupHelper
	 * and a topGroupList
	 * 
	 * @param groupName
	 * @param groupHelper
	 * @param topGroupList
	 */
	public TopGroupList(String groupName, GroupHelper groupHelper,
			TopGroupList topGroupList) {
	...
	public void addGroup(String groupName, HashMap<String, Group> stg) {
		SubGroupList g = new SubGroupList(groupName, new GroupHelper(null),
